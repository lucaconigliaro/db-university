...
SELECT `students`.`id`, `students`.`name`, `students`.`surname`, `courses`.`id` as `course_id`, `courses`.`name` as `course_name`, COUNT(`exam_student`.`vote`) as `num_tentativi`, MAX(`exam_student`.`vote`) as `max_vote`
FROM `students`
